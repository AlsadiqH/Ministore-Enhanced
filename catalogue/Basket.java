...
public class Basket extends ArrayList<Product> implements Serializable
{
  ...
  /**
   * Removes and returns the last item added to the basket
   * @return The last Product that was in the basket, or null if basket is empty
   */
  public Product removeLastItem() {
    if (isEmpty()) {
      return null;
    }
  ...
  /**
   * Check if basket contains any products
   * @return boolean indicating if basket is empty
   */
